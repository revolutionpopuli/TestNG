...
public class BaseDriverParameter {
    ...
    public void baslangicIslemleri(String browser) {
        ...
        if (browser.equalsIgnoreCase("chrome")) {
            System.setProperty(ChromeDriverService.CHROME_DRIVER_SILENT_OUTPUT_PROPERTY, "true");  // ChromeServisi sessiz modda çalıştır
            ...
            System.out.println("Firefox Driver was started successfully.");
